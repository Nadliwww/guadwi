...
echo "https://wa.me/6282334170916"
...
echo -e "\033[1;33mFax BOT BERHASIL DI INSTALL KETIK NPM START UNTUK MENJALANKAN Fax botz jika ada eror silahkan hubungi kami\033[0m"
echo -e "> enter to next"
read enter
clear
